...
async function getName(latitude, longitude) {
    var access_key = '9390da9b3dd262062d8d5420d1f99958'
...
async function fetchData(location) {
    var url = `https://api.weatherapi.com/v1/current.json?key=22e4d919c59948979ce162833232107&q=` + location + `&aqi=yes`;
    var res = await fetch(url);
    var data = await res.json();
    if(res.status == 200){
        setValues(data);
